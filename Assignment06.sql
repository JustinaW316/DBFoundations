...
-- 2024-05-22,JustinaWoo,Completed File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_JWoo')
	 Begin 
	  Alter Database [Assignment06DB_JWoo] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_JWoo;
	 End
	Create Database Assignment06DB_JWoo;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_JWoo;
...
AS
SELECT DISTINCT TOP 10000 I.InventoryDate, E.EmployeeFirstName, E.EmployeeLastName
